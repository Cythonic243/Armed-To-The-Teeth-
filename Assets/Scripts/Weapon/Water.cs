...
public class Water : AttackBase
{
    ...
    public override void Launch(Vector2 direction, float force)
    {
        ...
        //transform.localRotation = Quaternion.AngleAxis(Vector2.Angle(direction, Vector2.right), Vector3.forward);
        // (Vector3.forward, Vector2.SignedAngle(direction, Vector2.right));
    }
